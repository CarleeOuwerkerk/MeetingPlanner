...
namespace MeetingPlanner.Controllers
{
    public class MeetingsController : Controller
    {
        ...
        public MeetingsController(MeetingPlannerContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("MeetingId,Conductor,OpeningHymn,OpeningPrayer,SacramentHymn,IntermediateHymn,ClosingHymn,ClosingPrayer,Date")] Meeting meeting)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MeetingId,Conductor,OpeningHymn,OpeningPrayer,SacramentHymn,IntermediateHymn,ClosingHymn,ClosingPrayer,Date")] Meeting meeting)
        {
